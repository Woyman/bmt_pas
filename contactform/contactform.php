...
$mail->IsSMTP();
$mail->SMTPSecure = 'tls';
$mail->Host = "mail.bmtpasbantul.com"; //hostname masing-masing provider email
$mail->SMTPDebug = 0;
$mail->Port = 587;
$mail->SMTPAuth = true;
$mail->Username = "_mainaccount@bmtpasbantul.com"; //user email
$mail->Password = "88etNS5hSfzB56"; //password email
$mail->SetFrom($email,$name); //set email pengirim
$mail->Subject = $subject; //subyek email
$mail->AddAddress("bmtpas@gmail.com","bmt pas"); //tujuan email
...
//   $contact_email_to = "woyman11@gmail.com";
