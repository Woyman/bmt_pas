<header>
            ...
            <div class="navigation">
              ...
              <div class="sidenav" id="sidenav">
                ...
                <ul id="list-menu-sidebar">
                  ...
                  <li class="dropdown">
                    <a href="#">PRODUK & LAYANAN <i class="icon-chevron-down dropdown-icon"></i> </a>
                    <ul class="dropdown-container">
            					<li class="dropdown">
                          <a href="#">Pembiayaan <i class="icon-chevron-down dropdown-icon"></i></a>
                          <ul class="dropdown-container">
                            <li><a href="pembiayaan-produktif">Pembiayaan Produktif</a></li>
                            <li><a href="pembiayaan-konsumtif">Pembiayaan Konsumtif</a></li>
                            <li><a href="pembiayaan-multiguna">Pembiayaan Multiguna</a></li>
                      ...
                      <li class="dropdown">
                        <a href="#">Tabungan <i class="icon-chevron-down dropdown-icon"></i></a>
                        <ul class="dropdown-container ">
                          <li><a href="tabungan-saham">Tabungan Saham</a></li>
                          <li><a href="tabungan-qurban">Tabungan Qurban</a></li>
                          <li><a href="tabungan-thr">Tabungan THR</a></li>
                  ...
                  <li><a href="lpz-pas">LPZ PAS - LAZNAS BSM</a></li>
                  <li>
                    <a href="gallery">GALERI</a>
                  </li>
                  <li class='dropdown' >                    
                      <a href="#">TENTANG KAMI <i class="icon-chevron-down dropdown-icon"></i> </a>
                      <ul class="dropdown-container">                        
                        <li><a href="profil">Profil</a></li>
                        <li><a href="manajemen">Manajemen</a></li>
                        <li><a href="sejarah">Sejarah</a></li>
                  ...
                  <li class="dropdown" style = "background-color: #b71200" >
                    <a href="#"><i class="icon-calendar icon-rounded"></i>Simulasi Perhitungan</a>
                    <ul class="dropdown-container">
                      <li><a href="simulasi" ></i>Simulasi Pembiayaan</a></li>
                      <li><a href="kalkulator-zakat" >Kalkulator Zakat</a>
                      </li>
                    </ul>
                  </li>
                </ul>
    ...
    <script>
      ...
      for (i = 0; i < dropdown.length; i++) {
        ...
        console.log(dropdown[i].firstElementChild)
